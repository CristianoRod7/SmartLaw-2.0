...
const ITDashboard = ({ onBack, onNavigateToAnalysis, onNavigateToSimulator }) => {
  return (
    <div className="w-full space-y-8 pb-20 font-sans">
      <header className="relative overflow-hidden rounded-[2.5rem] border border-purple-200/40 bg-gradient-to-br from-slate-950 via-slate-900 to-purple-950 p-8 text-white shadow-2xl md:p-10">
        ...
        <div className="relative z-10 flex flex-col gap-8 xl:flex-row xl:items-end xl:justify-between">
          <div className="space-y-5">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-3">
                <div className="inline-flex items-center gap-2 rounded-full border border-purple-400/20 bg-purple-400/10 px-3 py-1 text-xs font-bold uppercase tracking-[0.2em] text-purple-300">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:w-[520px]">
            <button
              ...
              className="flex items-center justify-center gap-3 rounded-2xl bg-purple-500 px-6 py-4 text-base font-black text-white shadow-lg shadow-purple-600/30 transition hover:-translate-y-0.5 hover:bg-purple-400"
            >
              <ShieldCheck size={20} />
              IT 계약 스캔하기
            </button>
            <button
              ...
              className="flex items-center justify-center gap-3 rounded-2xl bg-white px-6 py-4 text-base font-black text-slate-950 transition hover:-translate-y-0.5 hover:bg-purple-100"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 rounded-2xl border border-white/15 bg-white/10 px-6 py-4 text-base font-black text-white transition hover:bg-white/15 sm:col-span-2"
            >
              <LockKeyhole size={20} />
              NDA 점검
            </button>
      ...
      <section className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <div className="rounded-[2rem] border border-amber-100 bg-amber-50 p-7 shadow-sm">
        ...
        <div className="relative overflow-hidden rounded-[2rem] bg-purple-600 p-7 text-white shadow-lg">
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-[2.3rem] border border-slate-200 bg-white p-8 shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-500">IT 외주 전용 분석 시작</p>
            </div>
          </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="mt-1 break-keep text-sm text-slate-500">{item.desc}</div>
                  </div>
                </div>
                <ChevronRight className="text-slate-400 transition group-hover:text-purple-600" size={18} />
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="rounded-[2.3rem] border border-slate-200 bg-white p-8 shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-black text-slate-900">외주 분쟁 알림</h3>
              <p className="text-sm font-medium text-slate-500">계약서에서 먼저 확인할 위험 조항</p>
            </div>
          </div>

          <div className="grid grid-cols-1 gap-4 lg:grid-cols-5">
            {riskCards.map((risk) => (
              <div key={risk.title} className="rounded-2xl border border-slate-100 bg-slate-50 p-5">
                ...
                <button
                  onClick={() => onNavigateToAnalysis('IT 외주 계약서')}
                  className="mt-4 w-full rounded-2xl bg-white px-3 py-2 text-xs font-black text-purple-700 shadow-sm transition hover:bg-purple-50"
                >
                  관련 조항 확인하기
                </button>
                <p className="mt-2 text-[11px] font-bold text-slate-400">{risk.clause}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <div className="rounded-[2.3rem] border border-slate-200 bg-white p-8 shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-500">서명 전 최소 확인 항목</p>
            </div>
          </div>
          <div className="space-y-3">
            {checklist.map((item) => (
        ...
        <div className="rounded-[2.3rem] border border-slate-200 bg-slate-950 p-8 text-white shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            <div className="rounded-xl bg-white/10 p-2 text-purple-300">
              <Clock size={20} />
            </div>
            <div>
              <h3 className="text-xl font-black">권장 마일스톤</h3>
              <p className="text-sm font-medium text-slate-400">대금 회수와 검수 지연을 줄이는 구조</p>
            </div>
          </div>
